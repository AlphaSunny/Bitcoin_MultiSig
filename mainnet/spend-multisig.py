...
from bitcoinrpc.rpc import RawProxy

bitcoin = RawProxy() #creates an object called 'bitcoin' that allows for bitcoind calls

# YOU NEED AT LEAST TWO OF THE PRIVATE KEYS FROM PART ONE linked to your MULTI-SIG ADDRESS
multisigprivkeyone = "L4yE1gZdp7umjceWQywtPoriesVWRKzAD9FaCk9XrimmKuRPcEmL" #your key/brother one
multisigprivkeytwo = "Kwn9bKNgPLJq5hJxx6EpRTVyHXcsaqrNg6wQp6sjfSFQRerHE15f" #wallet service/brother two
multisigprivkeythree = "L5Dm2PDy1xdxZTKpLAGXUDKK7pT4QR4RNDDHcoxCaxMDbkyBXNuq" #safe deposit box/brother three
ChangeAddress = "3PpiN4mHiNDhpSQgyivfVAdXwwdgfMRbHr" #!!! Makes Sure to set your own personal Change Address
